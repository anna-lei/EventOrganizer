...
public class DatabaseService implements Serializable {
	...
	/**
	 * Überprüft, ob Inhalte in der Datenbank vorhanden sind. Beispielhaft wird die Tabelle User durchsucht.
	 * Ist diese  gefüllt, kann davon ausgegangen werden, dass auch Events existieren aufgrund der obigen PostConstruct-Methode.
	 * @return
	 */
	...
	public void initEventOrganizerData() {
		if (getContentTables()) {
			...
			User testUser = new User("Claudia", "Schaefers", new Date(System.currentTimeMillis()), "cs@jee.de", "123", true);
			...
			User manager1 = new User("Manager", "Thomas", today.getTime(), "Thomas.Manager@eventfull.de", "Event123", true);
			today.set(1988, 4, 20);
			User manager2 = new User("Managment", "Sabine", today.getTime(), "Sabine_Management@eventtickets.de", "Tickets23", true);
			today.set(1994, 7, 28);
