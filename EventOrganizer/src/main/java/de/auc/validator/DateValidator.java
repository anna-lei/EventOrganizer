 ...
 * Die Validerung des Formats dd.MM.yyyy HH:mm wird über die JSF-Seite gesteuert.
 */
@ManagedBean
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        if(value==null) {
    		...
    		if(date.before(today.getTime())) {
    			FacesMessage editMessage = new FacesMessage(FacesMessage.SEVERITY_ERROR,
    					"Das Event muss in der Zukunft liegen und im folgenden Format angegeben werden: dd.MM.yyyy HH:mm", "");
    			FacesContext.getCurrentInstance().addMessage("editform:edit", editMessage);
    		}
        }
	}
